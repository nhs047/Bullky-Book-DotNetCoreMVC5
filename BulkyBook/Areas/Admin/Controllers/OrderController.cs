...
namespace BulkyBook.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Details(int id)
        {
            ...
            {
                OrderHeader = _unitOfWork.OrderHeader.GetFirstOrDefult(u => u.Id == id,
        ...
        {
            OrderHeader orderHeader = _unitOfWork.OrderHeader.GetFirstOrDefult(u => u.Id == id);
        ...
        {
            OrderHeader orderHeader = _unitOfWork.OrderHeader.GetFirstOrDefult(u => u.Id == OrderDetailsVM.OrderHeader.Id);
        ...
        {
            OrderHeader orderHeader = _unitOfWork.OrderHeader.GetFirstOrDefult(u =>
                    u.Id == OrderDetailsVM.OrderHeader.Id, includeProperties: "ApplicationUser");
            if (stripeToken != null)
            {
        ...
        public IActionResult GetOrderList(string status)
        {
            ...
            {
                orderHeaderList = _unitOfWork.OrderHeader.GetAll(u => true, includeProperties: "ApplicationUser");
            }
            else
            {
